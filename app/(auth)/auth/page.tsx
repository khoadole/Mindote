...
export default function AuthPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      const { error } = await signInWithGoogle({ nonce });
          ...
          <Card className="border-border/50 shadow-lg relative z-10 bg-background">
            ...
            <CardContent>
              ...
              <div className="mt-6 text-center">
                ...
                <Button
                  variant="outline"
                  className="w-full mt-4 bg-white dark:bg-transparent hover:bg-gray-50 dark:hover:bg-primary/10 dark:hover:text-primary dark:text-foreground"
