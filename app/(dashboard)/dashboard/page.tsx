...
export default function Dashboard() {
  ...
  return (
    <div className="p-4 md:p-8 min-h-screen bg-white dark:from-background dark:via-background dark:to-primary/5 relative overflow-hidden transition-all duration-300">
