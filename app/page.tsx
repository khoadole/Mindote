...
import { BookOpen, Layers, Plus, Candy as Cards, CheckCircle } from "lucide-react"
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              <AddWordModal
                trigger={
                  <Button className="flex items-center gap-2" data-shortcut="add-word">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">Keep building your vocabulary</p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">Organized learning topics</p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">Words ready for review</p>
                </CardContent>
              </Card>
            </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  {recentCollections.map((collection) => (
                    <div key={collection.id} className="flex items-center justify-between p-4 rounded-lg border">
                      <div className="flex items-center space-x-3">
                        <div className={`h-3 w-3 rounded-full ${collection.color}`} />
                        <div>
                          <h3 className="font-medium">{collection.name}</h3>
                          <p className="text-sm text-muted-foreground">
                            {words.filter((w) => w.collectionId === collection.id).length} words
                          </p>
                        </div>
                      </div>
